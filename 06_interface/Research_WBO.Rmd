...
df_ab_prep_nl[18,] <- c("2021", "Nederland", "PWC, NLE", 8400000,  382000,  8800000,  230000)
df_ab_prep_nl[19,] <- c("2030", "Nederland", "PWC", 7500000, 1900000,  9400000, 1700000)
df_ab_prep_nl[20,] <- c("2040", "Nederland", "PWC", 4100000, 5900000, 10000000, 3200000)
df_ab_prep_nl[21,] <- c("2050", "Nederland", "PWC",  700000, 9900000, 10600000, 4800000)
...
### Table A31 Overzichtstabel scenarios (2024 versus 2040)
```{r table_A31}
#| label: R-code tbl A31
...
```{r plot_A32b, echo = FALSE, warning = FALSE, message = FALSE}
